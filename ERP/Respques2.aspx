<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Respques2.aspx.vb" Inherits="ERP.Respques2" %>
 	...
 	<div class="container-box">
 		<div class="main">
 			<div class="content">
                 ...
                 <asp:Button ID="Button1" runat="server" Text="Choose" CssClass="btn" AutoPostback = false/>
 			</div>
 		</div>
 	</div>
 <!-- </div>
