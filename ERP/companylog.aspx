<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="companylog.aspx.vb" Inherits="ERP.companylog" %>
   ...
   <form id="form2" runat="server" >
	<div id="homesection" class="intro">
	 ...
	 <ul>
         ...
         <li><asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/mysurvey2.aspx">My Surveys</asp:HyperLink></li> 
          	<li><asp:HyperLink ID="Report" runat="server" NavigateUrl="~/Report.aspx">Report</asp:HyperLink></li> 	
