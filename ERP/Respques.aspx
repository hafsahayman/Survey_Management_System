<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Respques.aspx.vb" Inherits="ERP.Respques" %>
...
<div class="login-form">
 ...
 <div class=form-container> -->
    ...
    <asp:Button ID="Button2" runat="server" Text="Submit" CssClass="submit" />
<%--     <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="RadioButtonList5" ErrorMessage="Please choose an option" BackColor="White"></asp:RequiredFieldValidator>--%>
</div>
    </form>
</body>
</html>
